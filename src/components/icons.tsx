export function MagicWandIcon({ className = '' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" aria-hidden>
      <path
        d="M15 4l5 5M4 20l4-4M14.5 6.5L8 13l-1 3 3-1 6.5-6.5zM18 2l4 4"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
...
export function CopyIcon({ className = '' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" aria-hidden>
      ...
      <path d="M6 16H5a2 2 0 01-2-2V5a2 2 0 012-2h9a2 2 0 012 2v1" stroke="currentColor" strokeWidth="1.5" />
    </svg>
  )
}
...
export function AnalysisMarkerIcon({ className = '' }: { className?: string }) {
  return (
